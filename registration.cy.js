...
Cypress.on('uncaught:exception', (err, runnable) => {
  ...
  //----------Email without name------//
    ...
    it('Registration with valid Email',()=>{
      cy.get('#email_create').clear().type('sampleUser4@gmail.com')
      cy.get('#SubmitCreate > span').click() 
      cy.wait(15000)
    })
    ...
    it('Registration with filling required fields',()=>{
      ...
      cy.get('#email').should('have.value','sampleUser4@gmail.com').click().should('have.css','color','rgb(53, 179, 63)')
      ...
      cy.get('#id_state').select(33).should('have.value','33')
      cy.get('#postcode').type('12345').should('have.value','12345')
      cy.get('#id_country').should('have.value',21)
      cy.get('#phone_mobile').type('0599344870').should('have.value','0599344870')
